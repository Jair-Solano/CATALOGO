...
<head>
  ...
  <header class="main-header"
    style="display:flex; justify-content:flex-end; padding: 10px 20px; background: #a1001f; color: white;">
    <a href="../carrito/carrito de compras.php" style="color: white; font-weight: bold; text-decoration: none;"
      id="carrito-link">
  ...
  <section style="text-align: center; padding: 20px; background: #fff4d9;">
    <form method="GET" style="display: flex; flex-wrap: wrap; gap: 1em; justify-content: center; align-items: center;">
      ...
      <button type="submit"
        style="padding: 0.5em 1.2em; border-radius: 10px; border: none; background: #a1001f; color: white; font-weight: bold;">Buscar</button>
    </form>
  </section>
  ...
  <script>
    ...
    // Al cargar la página actualizar
