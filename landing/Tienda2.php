        ...
        <div class="product-info">
          ...
          <div class="product-rating">
            <?php 
              ...
              for($k=1;$k<=5;$k++) {
                $off = $k > $rating ? ' off' : '';
                echo '<img src="assets/imagenes/muslito.png" alt="Muslito" class="muslito'.$off.'" />';
              }
            ?>
          </div>
  ...
  <script>
    document.querySelectorAll('.product-card').forEach(card => {
      card.addEventListener('click', function() {
        ...
        let muslitos = '';
        for(let i=1;i<=5;i++) {
          muslitos += `<img src="assets/imagenes/muslito.png" alt="Muslito" style="width:28px;opacity:${i<=rating?1:0.3};margin:0 2px;">`;
        }
